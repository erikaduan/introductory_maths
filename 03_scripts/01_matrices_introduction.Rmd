...
+ Subsetting a matrix (via a listed nest) in Python requires a sequence of square brackets i.e. [outer list - row position][inner list - column position].
...
Subsetting and slicing matrices is much simpler when they are stored as numpy arrays. The resulting product is also stored as a numpy array.  
