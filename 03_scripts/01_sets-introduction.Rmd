...
We can also use set notation to define subsets by asserting new subset properties i.e. a condition $S(x)$ only holds true for a subset of elements within a set.    
