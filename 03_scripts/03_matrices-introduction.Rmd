...
A matrix can be thought of as a two dimensional container which stores a set of vectors (i.e. an ordered collection of column vectors). A matrix $A \in {\rm I\!R} ^{m\times n}$ is defined below.    
