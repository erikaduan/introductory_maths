...
Vector orthoganality is used to describe vector perpendicularity to vectors in any number of dimensions. Mathematically, a pair of vectors $x$ and $y$ are orthogonal ($x\perp y$) if:   
