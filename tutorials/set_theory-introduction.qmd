...
De Morgan's law is less immediately obvious and can be visualised by Venn diagrams or (more preferably) proven mathematically.   
...
From proof 1, $\overline{A\cup B} \subseteq \bar A \cap \bar B$   
