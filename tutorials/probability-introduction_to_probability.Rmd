...
When a set has 3 elements, the combinations for a subset containing 2 elements is represented as $\frac{3!}{(3-2)!\times 2!}$ or ${3\choose2}$.   
For the same set, the combinations for a subset containing 1 element is represented as $\frac{3!}{(3-1)!\times 1!}$.   

**Note:** $\frac{3!}{(3-2)!\times 2!}= \frac{3!}{(3-1)!\times 1!} = \frac{3!}{2!}$. This explains the graph symmetry of power sets.    
