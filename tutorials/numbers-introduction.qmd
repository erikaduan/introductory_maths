...
This tutorial describes the properties of each number classes. Number class annotation, such as $\mathbb{R}$ is used in mathematical formulas to describe the basic behaviour of input or output functions.   

This tutorial also introduces the concept of the binary number system and illustrates how it differs to the decimal (counting) number system. The binary number system is used by modern computer applications, which describes applications as either 32-bit or 64-bit for example.    
:::
