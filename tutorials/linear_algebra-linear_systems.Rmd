...
+ Each leading entry (or pivot column of a row) is located to the right of the leading entry of the row above it. Each leading entry in the echelon form represents a **basic variable** in the linear system.     
